...
export default function Analytics() {
  ...
  const tools = [
    ...
    },
    {
      ...
      description: 'Monitor conversion rates and goals.'
    },
    {
      name: 'A/B Test Manager',
      description: 'Run and analyze A/B tests.'
    },
    {
      name: 'Revenue Analytics',
      description: 'Track and forecast revenue metrics.'
    },
    {
      name: 'User Behavior Tracker',
      description: 'Analyze user interactions and flows.'
    },
    {
    ...
    },
    {
      ...
      description: 'Create customized analytics reports.'
    }
  ];
      ...
      <div className="flex items-center mb-8 relative">
        ...
        <div className="relative flex items-center">
          ...
          <div>
            ...
            <p className="text-blue-300/60">Gain insights from your data</p>
          </div>
        </div>
      </div>

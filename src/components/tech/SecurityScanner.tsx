...
import { Database, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const SecurityScanner: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for database queries! I can help you with database query tool tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new database queries item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create database queries items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new database for my project"
            </p>
          </div>
        ) : (

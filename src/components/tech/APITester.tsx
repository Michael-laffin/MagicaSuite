...
import { Globe, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const APITester: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for API testing! I can help you with api tester tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new API testing item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create API testing items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new API for my project"
            </p>
          </div>
        ) : (

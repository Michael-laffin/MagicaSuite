...
const ResourcePlanning: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for tax calculation! I can help you with tax calculator tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new tax calculation item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create tax calculation items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new tax for my project"
            </p>
          </div>
        ) : (

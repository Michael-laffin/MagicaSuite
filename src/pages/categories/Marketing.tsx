...
export default function Marketing() {
  ...
  const tools = [
    ...
    },
    {
      ...
      description: 'Create high-converting pages.'
    },
    {
    ...
    },
    {
      ...
      description: 'Track marketing metrics.'
    },
    {
      name: 'SEO Optimizer',
    ...
    },
    {
      ...
      description: 'Organize brand materials.'
    },
    {
      ...
      <div className="flex items-center mb-8 relative">
        ...
        <div className="relative flex items-center">
          ...
          <div>
            ...
            <p className="text-blue-300/60">Amplify your marketing efforts</p>
          </div>
        </div>
      </div>

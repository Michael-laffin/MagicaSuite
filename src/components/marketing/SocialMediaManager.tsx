...
const SocialMediaManager: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for social media management! I can help you with social media scheduler tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new social media management item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create social media management items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new social for my project"
            </p>
          </div>
        ) : (

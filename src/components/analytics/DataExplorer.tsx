...
const DataExplorer: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for A/B testing! I can help you with a/b test planner tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new A/B testing item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            <Split className="w-12 h-12 mx-auto mb-4 opacity-30" />
            <p className="text-lg mb-2">No items yet</p>
            <p className="text-sm">Use AI to create A/B testing items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new A/B for my project"
            </p>
          </div>
        ) : (

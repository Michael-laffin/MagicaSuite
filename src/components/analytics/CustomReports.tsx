...
import { ClipboardList, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const CustomReports: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for survey creation! I can help you with survey creator tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new survey creation item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create survey creation items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new survey for my project"
            </p>
          </div>
        ) : (

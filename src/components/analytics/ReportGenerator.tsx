...
import { LayoutDashboard, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const ReportGenerator: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for data dashboards! I can help you with data dashboard tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new data dashboards item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create data dashboards items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new data for my project"
            </p>
          </div>
        ) : (

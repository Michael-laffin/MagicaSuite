...
import { Lock, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const DevOpsDashboard: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for password management! I can help you with password manager tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new password management item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create password management items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new password for my project"
            </p>
          </div>
        ) : (

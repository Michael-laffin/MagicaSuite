...
import { Image, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const ImageEditor: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for photo editing! I can help you with photo editor tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new photo editing item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create photo editing items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new photo for my project"
            </p>
          </div>
        ) : (

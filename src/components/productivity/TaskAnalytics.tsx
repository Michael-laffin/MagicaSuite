...
const TaskAnalytics: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for meeting scheduling! I can help you with meeting scheduler tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new meeting scheduling item' },
      ...
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create meeting scheduling items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new meeting for my project"
            </p>
          </div>
        ) : (

...
import { Mail, Sparkles, Plus, Trash2 } from 'lucide-react';
...
const EmailCampaigns: React.FC = () => {
  ...
  const { messages, isTyping, sendMessage } = useAIChat(
    "👋 I'm your AI assistant for email campaigns! I can help you with email campaign builder tasks using natural language. Just tell me what you need!"
  );
  ...
  const quickActions = [
    { label: '✨ Create new', prompt: 'Create a new email campaigns item' },
  ...
  return (
    <AIToolLayout
      ...
      toolName="Email Campaign Builder"
    >
      <div className="space-y-4">
        ...
        {items.length === 0 ? (
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-sm">Use AI to create email campaigns items!</p>
            <p className="text-xs mt-3 text-gray-600">
              Try: "Create a new email for my project"
            </p>
          </div>
        ) : (
